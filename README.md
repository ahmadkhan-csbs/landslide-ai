...
![Python](https://img.shields.io/badge/Python-3.12-blue) ![FastAPI](https://img.shields.io/badge/FastAPI-Latest-green) ![ML](https://img.shields.io/badge/Model-Random%20Forest-orange) ![Accuracy](https://img.shields.io/badge/Accuracy-93.6%25-brightgreen)
...
| `GET /alerts` | Live risk alerts for 8 major NER cities |
...
```json
{
  ...
  "factors": {
    "rainfall_mm": 380,
    "main_reason": "Heavy monsoon rainfall + fragile terrain"
  }
}
```
...
`Guwahati` · `Shillong` · `Imphal` · `Kohima` · `Aizawl` · `Agartala` · `Itanagar` · `Gangtok## 🎯 Future Scope

- [ ] Real-time rainfall data (IMD/API integration)
- [ ] Citizen report feature (photo + GPS)
